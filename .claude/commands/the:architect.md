Invoke the architect agent for architecture work.

**How to use:**
- In chat: type `@architect` followed by your request
- From CLI: run `claude --agent architect`

The architect coordinates all architecture and implementation work. It will present numbered options before delegating to specialized subagents (iterate, validate, drift, implement-*, test, review).
