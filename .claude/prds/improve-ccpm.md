...
- Move `.claude/epics/` to a new location outside `.claude/` (proposed: `.pm/epics/`)
- Move `.claude/prds/` to a new location outside `.claude/` (proposed: `.pm/prds/`)
