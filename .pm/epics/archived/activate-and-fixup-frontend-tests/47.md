...
- The file imports `main.LifeTheme`, `main.Objective`, `main.KeyResult` from `../wails/wailsjs/go/models` — verify these resolve in jsdom environment. If not, inline the test fixtures as plain objects matching the type shape.
