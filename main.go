...
func (a *App) RecordRoutineCompletions(day managers.DayFocus, previousChecks []string) error {
	return a.planningManager.RecordRoutineCompletions(day, previousChecks)
}
